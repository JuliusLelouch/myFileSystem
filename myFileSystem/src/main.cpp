...
int main(){
    ...
    fileSystem.FormatFileSystem();
        ...
        {
            cerr<<"ls: list files in current directory"<<endl;
            cerr<<"cd <dir>: change directory"<<endl;
            cerr<<"mkdir <dir>: make directory"<<endl;
            cerr<<"fformat: format file system"<<endl;
            cerr<<"fcreat <filename> <mode>: create file"<<endl;
            cerr<<"fopen <filename> <mode>: open file"<<endl;
            cerr<<"fclose <fd>: close file"<<endl;
            cerr<<"fread <fd> <size>: read file"<<endl;
            cerr<<"fwrite <fd> <size>: write file"<<endl;
            cerr<<"flseek <fd> <offset> <type>: seek file"<<endl;
            cerr<<"fdelete <filename>: delete file"<<endl;
        }
